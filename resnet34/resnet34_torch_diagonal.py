...
def dct_comp(x):
    ...
    r = decompress(torch.squeeze(x[:,0,:]), lhs,rhs, idx, cf_nrows, cf_ncols)
    g = decompress(torch.squeeze(x[:,1,:]), lhs,rhs, idx, cf_nrows, cf_ncols)
    b = decompress(torch.squeeze(x[:,2,:]), lhs,rhs, idx, cf_nrows, cf_ncols)
