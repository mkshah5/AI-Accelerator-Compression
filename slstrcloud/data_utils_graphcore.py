...
def get_data_generator(dataset_dir: str, param,opts_t, opts_v):
    global PARAMS_C
    PARAMS_C = param
    ...
    train_data_loader = poptorch.DataLoader(options=opts_t,
                                            dataset=train_dataset, 
                                            batch_size=param.batch_size, 
                                            shuffle=True,
                                            num_workers=1,
                                            drop_last=True)
    test_data_loader = poptorch.DataLoader(options=opts_v,
