...
class UNetSkeleton(nn.Module):
    ...
    def __init__(self, input_shape=(256,256,9)):
        ...
        #decoder
        self.block5 = []
        self.b5_start = nn.Upsample(scale_factor=2, mode='bilinear', align_corners=False)
        ...
        self.block6 = []
        self.b6_start = nn.Upsample(scale_factor=2, mode='bilinear', align_corners=False)
        ...
        self.block7 = []
        self.b7_start = nn.Upsample(scale_factor=2, mode='bilinear', align_corners=False)
