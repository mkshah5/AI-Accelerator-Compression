...
from compressor.compress_entry_highres import compress_sfactor, decompress_sfactor, get_lhs_rhs_decompress, get_new_params
...
def full_comp(x):
    # compress_sfactor(A, params: TrainingParams,sfactor=1)
...
class CompressorModel(nn.Module):
    def __init__(self):
        ...
        self.decompress = decompress_sfactor
