...
def get_data_generator(base_dataset_dir: Path, batch_size: int, is_inference=False,opts_t=None, opts_v=None):
    ...
    if is_inference: 
        ...
        em_inference_generator = poptorch.DataLoader(options=opts,
                                                  dataset=em_inference_dataset,
        ...
        em_denoise_generator = poptorch.DataLoader(options=opts,
                                                  dataset=em_denoise_dataset,
                                                  batch_size=batch_size,
                                                  shuffle=shuffle_flag,
                                                  drop_last=True)
